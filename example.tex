...
\usepackage{tikzpagenodes} % for the takeaway box
...
%% Some options for frame highlight/takeaway/key point
\setbeamercolor{takeaway}{fg=black,bg=byuOrange!25!white}
\newcommand{\takeawayf}[1]{% simple version (floating)
  \vfill
  \begin{beamercolorbox}[wd=\linewidth,rounded=true]{takeaway}
    \centering
    \textbf{Takeaway:} #1
  \end{beamercolorbox}
}
\newcommand{\takeaway}[1]{% pinned just above footline
  \AddToHookNext{shipout/foreground}{%
    \begin{tikzpicture}[remember picture,overlay]
      \node[
        anchor=south,
        yshift=0ex, % adjusts height from footline
        fill=byuOrange!25!white,
        % draw=byuOrange!80!black,
        rounded corners=4pt,
        inner xsep=1ex,
        inner ysep=0.1ex,
        text height=2.1ex,
        text depth=1.0ex,
        text width=\dimexpr\textwidth-1.6em\relax,
        align=center
...
\definecolor{bangboxColor}{RGB}{255, 229, 153}
\newcommand{\bangbox}[1]{% pushes box to bottom and text to top
  \vskip0pt plus 1filll
  \noindent%
  \colorbox{bangboxColor}{%
...
\takeaway{Nice looking lists!}
% \bangbox{Nice looking lists!}
...
\begin{frame}{Math}
  ...
  \begin{equation}
    \min_{\symbf{u}} \quad \sum_{k=0}^{T} \| \tilde{\symbf{x}}_k \|_Q^2 + \| \tilde{\symbf{u}}_k \|_R^2
  \end{equation}

  \begin{equation}
    \symbf{u}_{\textnormal{min}} \leq \symbf{u}_k \leq \symbf{u}_{\textnormal{max}}
  \end{equation}

  \takeaway{Math is good for you.}
